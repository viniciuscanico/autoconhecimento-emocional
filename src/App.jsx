...
useEffect(() => {
  ...
  const allMoods = [
    { id: 'pleno', emoji: '✨', name: 'Plena(o)', value: 10, color: '#8A2BE2' },
    { id: 'empolgado', emoji: '🤩', name: 'Empolgada(o)', value: 9, color: '#FFD700' },
    { id: 'orgulhoso', emoji: '😌', name: 'Orgulhosa(o)', value: 8, color: '#FF8C00' },
    { id: 'feliz', emoji: '😊', name: 'Feliz', value: 7, color: '#F0E68C' },
    { id: 'amado', emoji: '🥰', name: 'Amada(o)', value: 6, color: '#FF00FF' },
    { id: 'moido_feliz', emoji: '😅', name: 'Moída(o) mas feliz', value: 5, color: '#32CD32' },
    { id: 'esperancoso', emoji: '🌱', name: 'Esperançosa(o)', value: 4, color: '#228B22' },
    { id: 'grato', emoji: '🙏', name: 'Grata(o)', value: 3, color: '#FFB6C1' },
    { id: 'contente', emoji: '🙂', name: 'Contente', value: 2, color: '#87CEEB' },
    { id: 'calmo', emoji: '🧘', name: 'Calma(o)', value: 1, color: '#ADD8E6' },
    { id: 'de_boa', emoji: '😏', name: 'De Boa', value: 0, color: '#B2F2BB' },
    { id: 'entediado', emoji: '🥱', name: 'Entediada(o)', value: -1, color: '#A9A9A9' },
    { id: 'cansado', emoji: '😮‍💨', name: 'Cansada(o)', value: -2, color: '#778899' },
    { id: 'com_fome', emoji: '🤤', name: 'Com Fome', value: -3, color: '#8B4513' },
    { id: 'ansioso', emoji: '😬', name: 'Ansiosa(o)', value: -4, color: '#556B2F' },
    { id: 'frustrado', emoji: '😤', name: 'Frustrada(o)', value: -5, color: '#B8860B' },
    { id: 'chateado', emoji: '😕', name: 'Chateada(o)', value: -6, color: '#FF7F50' },
    ...
    { id: 'abatido', emoji: '😩', name: 'Abatida(o)', value: -10, color: '#1E3A8A' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50 font-['Space_Grotesk']">
      ...
      <div className="w-full min-h-screen bg-white overflow-hidden flex flex-col transition-all duration-300">
        ...
        <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 px-2 py-3 z-50">
          <div className="flex gap-1">
            <button
